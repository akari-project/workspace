...
| 类别 | 事件 |
|---|---|
| 安全类 | 注册验证码、找回密码、有人尝试用已注册邮箱注册、新增设备、异常登录、密码或二次验证变更、恢复码不足、导出链接重置、账号暂停与注销、管理员邀请（模板 `staff_invitation`，收件人可能没有账号，spec/10 AUTH-22）、管理员角色变更（模板 `staff_roles_changed`） |
